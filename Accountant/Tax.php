...
<main class="site-main">
    ...
    <div class="row" style="margin-left:10% ">
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="TaxDB.php">
                ...
                <div style="padding-top: 10px">
                    <label style="margin-right: 219px"> Tax Details : </label>
                    <input type="text" id="Pname" name="Pname" class="text" value="" > <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 215px">  Tax Amount : </label>
