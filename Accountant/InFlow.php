...
<main class="site-main">
    ...
    <div class="row" style="margin-left:10% ">
        ...
        <div id="logtext">
            ...
            <?php
            $result = mysqli_query($conn, "SELECT TransactionID,TransactionDate,TransactionType,TransactionAmount from transactions where TransactionType='Income'");
            ?>
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="INDB.php">
                ...
                <div style="padding-top: 10px">
                    <label style="margin-right: 195px">  Income Amount : </label>
