...
<main class="site-main">
    ...
    <div class="row" style="margin-left:10% ">
       ...
       cus.Cusname,cus.mobile,cus.Email from transactions t, customer cus,repairservice r
where cus.CustomerNIC=r.CustomerID and r.TransactionID=t.TransactionID and TransactionType='Income'");
            ?>
