...
<main class="site-main">
    ...
    <div class="row" style="margin-left:10% ">
        ...
        <div id="logtext">
            ...
            <?php
            $result = mysqli_query($conn, "SELECT TransactionID,TransactionDate,TransactionType,
       TransactionAmount from transactions ");
            ?>
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="ADB.php">
                ...
                <div style="padding-top: 10px">
                    <label style="margin-right: 185px"> Expences Details : </label>
                    <input type="text" id="Pname" name="Pname" class="text" value="" > <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 175px">  Expences Amount : </label>
                    <input type="number" id="unit" name="unit" class="text" value="" >
                    <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 185px"> Transaction Date : </label>
