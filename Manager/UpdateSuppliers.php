...
<main class="site-main">
    ...
    <div class="row"  style="margin-left:10% ">
                    ...
                    <tr>
                        ...
                        <div style="padding-left: 20px">
                            <td style="border-left: 1px solid #b9b9b9">
                                <a style="text-decoration:none;" href="UpdateSuppliers.php?id=<?php echo $row['SupplierID'] ?>&name=<?php echo $row['SupplierName']?>&qty=<?php echo $row['Email']?> ">
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="UpdateSupplierDB.php">


                <div style="padding-top: 10px">
                    <label style="margin-right: 232px"> Supplier ID :  </label>
                    <input type="text" id="Id" name="Id" class="text"  value="<?php echo $id?>" readonly> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 205px"> Supplier Names :  </label>
                    <input type="text" id="Pname" name="Pname" class="text"  value="<?php echo $name?>" required> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 262px"> Email :  </label>
                    <input type="text" id="Pqty" name="Pqty" class="text"  value="<?php echo $UnitPrice?>" required> <br>
                </div>
