...
<main class="site-main">
    ...
    <div class="row"  style="margin-left:10% ">
        ...
        <div id="logtext">
            ...
            <form method="POST" action="SPDB.php">
                <div style="margin-top: 50px">
                    <div class="alignLeft" style="margin-top: 5px">Parts ID</div>
                    <input type="text" name="PID" style="margin-left: 104px;width: 300px">
                </div>
                <div style="margin-top: 50px">
                    <div class="alignLeft" style="margin-top: 5px">Parts Name</div>
                    <input type="text" name="Pname" style="margin-left: 80px;width: 300px">
                </div>
                <div style="margin-top: 50px">
                    <div class="alignLeft" style="margin-top: 5px">Quantity</div>
                    <input type="number" name="qty" style="margin-left: 98px;width: 300px">
                </div>
