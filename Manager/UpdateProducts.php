...
<main class="site-main">
    ...
    <div class="row"  style="margin-left:10% ">
                    ...
                    <tr>
                        ...
                        <div style="padding-left: 20px">
                            <td style="border-left: 1px solid #b9b9b9">
                                <a style="text-decoration:none;" href="UpdateProducts.php?id=<?php echo $row['PartID'] ?>&name=<?php echo $row['PartDetails']?>&qty=<?php echo $row['UnitPrice']?> ">
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="updateProductDBphp.php">


                <div style="padding-top: 10px">
                    <label style="margin-right: 235px"> product ID :  </label>
                    <input type="text" id="Id" name="Id" class="text"  value="<?php echo $id?>" readonly> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 205px"> product Names :  </label>
                    <input type="text" id="Pname" name="Pname" class="text"  value="<?php echo $name?>" required> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 195px"> product Quantity :  </label>
