    ...
    <div class="row" style="margin-left:10% ">
        ...
        <div id="logtext">
            <div align="center">
                ...
                <h2 style="color:#3C0" ;> EXPENCES REPORT</h2>
            </div>
            <form method="get" name="report_month">
                ...
                $result2 = mysqli_query($conn,"select sum(TransactionAmount) from transactions where TransactionType='Expences'");
...
from transactions where TransactionType='Expences' and 
...
TransactionDate  BETWEEN '$fd' and '$td'and TransactionType='Expences' ");
                ...
                <div style="padding-top: 10px; padding-left: 150px">
                    ...
                    <label>Total</label> <label style="float: right; margin-right: 290px"><?php echo$x[0]?></label>
        ...
        <div id="logtext">
            <div align="center">
                ...
                <h2 style="color:#3C0" ;> OUTFLOW REPORT</h2>
            </div>
            <form method="get" name="report_month1">
                ...
                //                echo $dp1;
                $result12 = mysqli_query($conn, "select sum(PaymentAmount) from cashflow where FlowType='Outflow'");
...
from cashflow where FlowType='Outflow'   order by PaymentAmount desc");

                }
                else if ($dp1 == "asc1") {

                    $result1 = mysqli_query($conn, "SELECT TransactionID,PaymentID,PaymentAmount
from cashflow where FlowType='Outflow'   order by PaymentAmount asc ");

                }
                else {

                    $result1 = mysqli_query($conn, "SELECT TransactionID,PaymentID,PaymentAmount
from cashflow where FlowType='Outflow'  ");
                ...
                <div style="padding-top: 10px; padding-left: 150px">
                    ...
                    <label>Total Outflow</label> <label
            ...
            <form method="get" name="report_month1">
                ...
                <div style="padding-top: 10px; padding-left: 150px">
                    ...
                    <label>Total Receivable</label> <label
                            style="float: right; margin-right: 150px"><?php echo $y?></label>
                    <br>
