        ...
        <div id="logtext">
            ...
            <form method="POST" action="AddSupplierDB.php">
                <div style="margin-top: 50px">
                    <div class="alignLeft" style="margin-top: 5px">Supplier ID</div>
                    <input type="text" name="PID" style="margin-left: 104px;width: 300px">
                </div>
                <div style="margin-top: 50px">
                    <div class="alignLeft" style="margin-top: 5px">Supplier Name</div>
                    <input type="text" name="Pname" style="margin-left: 80px;width: 300px">
                </div>
                <div style="margin-top: 50px">
                    <div class="alignLeft" style="margin-top: 5px">Email</div>
                    <input type="text" name="qty" style="margin-left: 135px;width: 300px">
                </div>
