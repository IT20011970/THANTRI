...
<main class="site-main">
    ...
    <div class="row"  style="margin-left:10% ">
        ...
        <div id="logtext">
            ...
            $result = mysqli_query($conn, "SELECT SupplierID,SupplierName,Email from supplier ");
            $id ="";
            $name="";
            $UnitPrice="";
            ?>
                    ...
                    <tr>
                        ...
                        <div style="padding-left: 20px">
                            <td style="border-left: 1px solid #b9b9b9">
                                <a style="text-decoration:none;" href="AddSupplies.php?id=<?php echo $row['SupplierID'] ?> ">
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="AddsuppliesDBphp.php">


                <div style="padding-top: 10px">
                    <label style="margin-right: 210px"> Supplier ID :  </label>
                    <input type="text" id="Id" name="Id" class="text"  value="<?php echo $id?>" readonly> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 230px"> Parts ID :  </label>
                    <input type="text" id="PID" name="PID" class="text"   required> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 205px"> Parts Names :  </label>
                    <input type="text" id="Pname" name="Pname" class="text"  required> <br>
                </div>
                <div style="padding-top: 10px">
                    <label style="margin-right: 195px"> Parts Quantity :  </label>
                    <input type="number" id="Pqty" name="Pqty" class="text"   required> <br>
                </div>


                <div style="padding-top: 10px">
                    <input type="submit" id="submitbt" name="sbtn" class="submitbtn" value="ADD">
