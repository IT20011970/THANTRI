...
<main class="site-main">
    ...
    <div class="row" style="margin-left:10% ">
                ...
                <table class="#" >
                    ...
                    <tr>
                        ...
                        <td style="border-left: 1px solid #b9b9b9">
                            <a style="text-decoration:none;" href="Order.php?id=<?php echo $row['PartID']; ?>&name=<?php echo $row['PartDetails']; ?>&qty=<?php echo $row['UnitPrice']; ?>">
        ...
        <div id="logtext">
            ...
            <form name="registerform" method="POST" target="_self" action="OrderPhp.php">
                ...
                <div style="padding-top: 10px">
                    <label style="margin-right: 200px"> Delivary Date: </label>
                    <input type="date" id="Drate" name="Drate" class="text" required> <br>
                </div>
                <div style="padding-top: 10px">
