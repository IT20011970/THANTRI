                    ...
                    <ul class="contact-info">
                        ...
                        <li class='contact-info-item'><a class='contact-info-icon-link'
                                        ...
                                        class="fa fa-envelope" style="color: ;"></i></a><span class="important"
                                                                                              style="color:  !important;"><span
                                        class="important">Send us a mail</span><br/><a
                                    ...
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                        href="../Accountant/Tax.php">Tax</a></li>
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                        href="../Accountant/A.php">Operational Expences</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                        <a href="">Cash Flow</a>
                                        <ul class="sub-menu ">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page ">
                                                <a
                                                        href="../Accountant/InFlow.php">In Flow</a>
                                            </li>
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page ">
                                                <a
                                                        href="../Accountant/OutFlow.php">Out Flow</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                        ...
                                        <ul class="sub-menu ">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page ">
                                                <a
                                                        href="../Accountant/ServiceView.php">Service Income</a>
                                            </li>
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page ">
                                                <a
                                                        href="../Accountant/OrderView.php">Order Income</a>
                                            </li>
                                        </ul>
                                    </li>
