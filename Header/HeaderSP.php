                                    ...
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                    href="../SP/Sales.php">Add Cuetomer</a></li>
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                    href="../SP/ViewCustomer.php">View Cuetomer</a></li>
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                    href="../SP/UpdateCustomer.php">Update Cuetomer</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                        ...
                                        <ul class="sub-menu ">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                                href="../SP/Order.php">Add Order</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a
                                                        href="">Service</a>
                                                <ul class="sub-menu">
                                                    <li class="menu-item menu-item-type-post_type menu-item-object-page"><a
                                                                href="../SP/Service.php">Add Service</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
